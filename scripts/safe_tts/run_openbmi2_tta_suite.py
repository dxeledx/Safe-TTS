...
DEFAULT_OUT_DIR = ROOT / "outputs" / "20260330" / "2class" / "ttime_suite_openbmi2_publicsrc_seed0_v1"
DEFAULT_METHODS = "eegnet_ea,tent,t3a,cotta,shot,coral"


def parse_args() -> tuple[argparse.Namespace, list[str]]:
    parser = argparse.ArgumentParser(
        description="Canonical wrapper for the OpenBMI (Lee2019_MI) 2-class strict-LOSO TTA suite."
    )

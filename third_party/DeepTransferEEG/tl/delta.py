...
def DELTA(loader, model, args, balanced=True):
    ...
    # NOTE: original implementation assumed binary classification (len(z)=2).
    # We extend it to multi-class by initializing z with uniform class priors.
    z = [1 / float(args.class_num)] * int(args.class_num)

...
# Optional dependency: learn2learn is only required for some meta-learning pipelines
# that are not used in SAFE_TTA's TTA suite. Guard the import to avoid import-time
# failures on minimal environments (e.g. remote server).
try:
    import learn2learn as l2l  # type: ignore
    from learn2learn.data.transforms import KShots, LoadData, NWays  # type: ignore
